...
<tileset version="1.2" tiledversion="1.3.3" name="dirt2" tilewidth="32" tileheight="32" spacing="2" margin="1" tilecount="48" columns="8">
 <image source="../images-extruded/tilesets/dirt2.png" width="272" height="204"/>
 <terraintypes>
  <terrain name="Dirt 2" tile="14"/>
 </terraintypes>
 <tile id="5" terrain=",,,0"/>
