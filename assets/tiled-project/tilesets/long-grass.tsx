...
<tileset version="1.2" tiledversion="2020.05.27" name="long-grass" tilewidth="32" tileheight="32" spacing="2" margin="1" tilecount="48" columns="8">
 <image source="../../images-extruded/tilesets/long-grass.png" width="272" height="204"/>
 <terraintypes>
  <terrain name="Long grass" tile="14"/>
 </terraintypes>
 <tile id="5" terrain=",,,0"/>
