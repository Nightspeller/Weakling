...
<tileset version="1.4" tiledversion="2020.09.09" name="grass1-dirt2" tilewidth="32" tileheight="32" spacing="2" margin="1" tilecount="48" columns="8">
 <image source="../../images-extruded/tilesets/grass1-dirt2.png" width="272" height="204"/>
 <wangsets>
  <wangset name="Converted Terrains" tile="-1">
   <wangcolor name="Dirt on grass" color="#ff0000" tile="0" probability="1"/>
