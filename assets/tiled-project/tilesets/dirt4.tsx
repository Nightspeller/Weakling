...
<tileset version="1.4" tiledversion="2020.12.18" name="dirt4" tilewidth="32" tileheight="32" spacing="2" margin="1" tilecount="48" columns="8">
 <image source="../../../src/assets/images-extruded/tilesets/dirt4.png" width="272" height="204"/>
 <wangsets>
  <wangset name="Terrains" type="corner" tile="-1">
   <wangcolor name="dirt4" color="#ff0000" tile="14" probability="1"/>
