define(["require", "exports", "phaser", "./adventurer", "../../config/constants", "../../data/quests/questsData", "../../data/achievementsData"], function (require, exports, Phaser, adventurer_1, constants_1, questsData_1, achievementsData_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.playerInstance = exports.Player = void 0;
    class Player extends adventurer_1.default {
        constructor() {
            super();
            this.name = 'Weakling';
            this.spriteParams = {
            ...
            this.achievements = achievementsData_1.default;
        }
        addQuest(questId) {
            if (!this.quests.find((existingQuest) => existingQuest.questId === questId)) {
                this.quests.unshift(questsData_1.default[questId]);
            }
            else {
        ...
        updateQuest(questId, state) {
            ...
            if (this.quests.length === Object.keys(questsData_1.default).length && shouldGetAchievement) {
        ...
        updateAchievement(name, newDescription, achieved, progressIncrement) {
            ...
            if (achievement === undefined)
                throw new Error(`Trying to update non-existing achievement: ${name}`);
            if (newDescription)
            ...
            this.achievements.forEach((achievementInArray) => {
                if (achievementInArray.achieved === false)
    ...
    exports.playerInstance = new Player();
});
