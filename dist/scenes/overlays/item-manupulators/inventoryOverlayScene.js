define(["require", "exports", "./generalItemManipulator", "../../../data/items/itemSlots"], function (require, exports, generalItemManipulator_1, itemSlots_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class InventoryOverlayScene extends generalItemManipulator_1.default {
        ...
        _adjustQuickSlots() {
            ...
            if (newQuickSlotsNumber < oldQuickSlotsNumber) {
                for (let i = oldQuickSlotsNumber - 1; i > newQuickSlotsNumber - 1; i -= 1) {
                    ...
                    if (itemToBeMoved) {
                        this._moveItemFromSlotToFirstPossible(`quickSlot${i}`, itemSlots_1.backpackSlotNames, undefined, true);
                    }
...
Actions: ${this.player.getAvailableActions()
        ...
        updatePlayerInventory(withCharacteristics) {
            ...
            this.itemsMap.forEach((itemR, slot) => {
                if (itemSlots_1.playerSlotNames.includes(slot)) {
            ...
            itemSlots_1.dollSlotNames.forEach((slot) => {
    ...
    exports.default = InventoryOverlayScene;
});
