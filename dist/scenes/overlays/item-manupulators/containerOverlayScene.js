define(["require", "exports", "../../../data/items/itemSlots", "./inventoryOverlayScene"], function (require, exports, itemSlots_1, inventoryOverlayScene_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ContainerOverlayScene extends inventoryOverlayScene_1.default {
        ...
        init({ opts, closeCallback, prevScene, numberOfSlots = 10, items = new Map(), name, }) {
            ...
            if (numberOfSlots < items.size)
                throw new Error('Trying to create container for more items than slots are there.');
        ...
        _takeAllItems() {
            itemSlots_1.containerSlotNames.forEach((slotName) => {
    ...
    exports.default = ContainerOverlayScene;
});
