define(["require", "exports", "../../characters/adventurers/player", "./generalOverlayScene"], function (require, exports, player_1, generalOverlayScene_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class CharacterPickerScene extends generalOverlayScene_1.default {
        constructor() {
        ...
        _drawCharacterOptions() {
            ...
            chars.forEach((char) => {
                ...
                char.on('pointerdown', function () {
                    self.player.worldImageSpriteParams = {
                    ...
                    anims.create({
                        key: 'walk_down',
                        frames: anims.generateFrameNames(self.player.worldImageSpriteParams.texture, {
                            start: 0,
                            end: 2,
                        }),
                        frameRate: 10,
                    ...
                    anims.create({
                        key: 'idle_up',
                        frames: [{
                                key: self.player.worldImageSpriteParams.texture,
                                frame: 19,
                            }],
                        frameRate: 10,
                        repeat: -1,
    ...
    exports.default = CharacterPickerScene;
});
