define(["require", "exports", "../../characters/adventurers/player", "./generalOverlayScene", "../../config/constants", "../../helpers/richText"], function (require, exports, player_1, generalOverlayScene_1, constants_1, richText_1) {
    ...
    class LevelUpScreenScene extends generalOverlayScene_1.default {
        constructor() {
        ...
        _drawLevelUpScreen() {
            this.add.text(constants_1.GAME_W / 2, 42, 'Level up!', {
                color: 'black',
                fontSize: '32px',
                fontStyle: 'bold',
            })
            ...
            const finishButton = new richText_1.default(this, 96, 200, 'Confirm!', { ...textOptions, padding: { x: 3, y: 3 } }, {
                color: 0x907748,
                width: 3,
                alpha: 1,
            }).setInteractive({ useHandCursor: true });
        ...
        _drawCharacteristics() {
            const textX = constants_1.GAME_W / 2 - 16;
            const textY = 64;
...
Actions: ${this.player.getAvailableActions()
    ...
    exports.default = LevelUpScreenScene;
});
