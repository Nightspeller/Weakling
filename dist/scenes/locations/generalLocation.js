    ...
    class GeneralLocation extends Phaser.Scene {
        ...
        showToggleMenuIcon() {
            ...
            this.add.graphics()
                ...
                .setDepth(10 - 1);
            const menuIconImage = this.add.image(+constants_1.GAME_W - 32 - 32 - 32 - 32, 32, 'icons', 'icons/music/harp')
                .setOrigin(0, 0)
                .setScrollFactor(0)
                .setInteractive({ useHandCursor: true })
                .setDepth(10 - 1);
        ...
        showToggleQuestLogIcon() {
            ...
            this.add.graphics()
                ...
                .setDepth(10 - 1);
            const questLogIconImage = this.add.image(+constants_1.GAME_W - 32 - 32 - 32 - 32 - 32 - 32, 32, 'icons', 'icons/books-and-scrolls/book-with-bookmark')
                .setOrigin(0, 0)
                .setScrollFactor(0)
                .setInteractive({ useHandCursor: true })
                .setDepth(10 - 1);
        ...
        showAchievementsIcon() {
            ...
            this.add.graphics()
                ...
                .setDepth(10 - 1);
            const achievementsIconImage = this.add.image(+constants_1.GAME_W - 32 - 32 - 32 - 32 - 32 - 32 - 32 - 32, 32, 'icons', 'icons/coins/large-coin-with-crown')
                .setOrigin(0, 0)
                .setScrollFactor(0)
                .setInteractive({ useHandCursor: true })
                .setDepth(10 - 1);
