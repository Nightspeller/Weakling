define(["require", "exports", "../generalLocation", "../../../data/dialogs/betweenVillageAndDungeon/patchDialog", "../../../data/itemsData", "../../../triggers/trigger"], function (require, exports, generalLocation_1, patchDialog_1, itemsData_1, trigger_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class BetweenVillageAndDungeonScene extends generalLocation_1.default {
        constructor() {
        ...
        create() {
            ...
            let currentDialog = patchDialog_1.firstTimePatchDialog;
            ...
            new trigger_1.default({
                ...
                callback: () => {
                    ...
                    const dialogLineToModify = currentDialog === patchDialog_1.firstTimePatchDialog ? 1 : 0;
                    ...
                    this.switchToScene('Dialog', {
                        ...
                        closeCallback: (param) => {
                            currentDialog = patchDialog_1.secondTimePatchDialog;
        ...
        drawPlant(plant) {
            ...
            if (plant.grown) {
                ...
                const trigger = new trigger_1.default({
                    ...
                    texture: itemsData_1.default[plant.plantId].sprite.texture,
                    frame: itemsData_1.default[plant.plantId].sprite.frame,
                    singleUse: true,
                    callback: () => {
    ...
    exports.default = BetweenVillageAndDungeonScene;
});
