define(["require", "exports", "phaser", "../../config/constants"], function (require, exports, Phaser, constants_1) {
    ...
    class IntroScene extends Phaser.Scene {
        ...
        create() {
            ...
            bgMusic.play();
            this.add.text(constants_1.GAME_W / 2, constants_1.GAME_H / 2 - 70, 'Still... Stay still... Calm... Stay calm... \n\n'
                ...
                .setOrigin(0.5, 0.5);
            const showHimVillage = this.add.text(constants_1.GAME_W / 2, constants_1.GAME_H / 2 + 200, 'Show him that lovely morning at the Village', {
                font: '14px monospace',
                color: '#ffffff',
            ...
            const showHimDungeon = this.add.text(constants_1.GAME_W / 2, constants_1.GAME_H / 2 + 250, 'Show him the dungeon', {
                font: '14px monospace',
                color: '#ffffff',
                backgroundColor: '#222222',
                padding: {
