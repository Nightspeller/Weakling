define(["require", "exports"], function (require, exports) {
    ...
    exports.farmerJoeDialogAftermath = exports.farmerJoeDialogPigsDead = exports.farmerJoeDialogQuestDiscussed = exports.farmerJoeDialogQuestDiscussedNoReward = exports.farmerJoeDialogQuestObtained = exports.farmerJoeDialogQuestNotObtained = void 0;
    exports.farmerJoeDialogQuestNotObtained = [{
            id: 'greetings',
    ...
    exports.farmerJoeDialogQuestObtained = [{
            id: 'greetings',
            text: 'What is it? Hope you brought some good news about that damned pigs?',
            replies: [{
    ...
    exports.farmerJoeDialogQuestDiscussedNoReward = [{
            id: 'greetings',
            text: 'What is it? Hope you brought some good news about that damned pigs?',
            replies: [{
    ...
    exports.farmerJoeDialogQuestDiscussed = [{
            id: 'greetings',
            text: 'What is it? Hope you brought some good news about that damned pigs?',
            replies: [{
                    text: 'No, still working on it - they are fat and scary, you know!',
    ...
    exports.farmerJoeDialogPigsDead = [{
            id: 'greetings',
            text: 'What is it? Hope you brought some good news about that damned pigs?',
            replies: [{
    ...
    exports.farmerJoeDialogAftermath = [{
            id: 'greetings',
...
//# sourceMappingURL=farmerJoeDialog.js.map