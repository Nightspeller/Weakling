define(["require", "exports"], function (require, exports) {
    ...
    exports.frettAfterTrueNameCalledDialog = exports.frettHowCanIHelpYouDialog = exports.frettRepeatStoryDialog = exports.frettObservedReadingAndInterestDialog = exports.frettObservedReadingDialog = exports.frettDialog = void 0;
    exports.frettDialog = [{
            id: 'greetings',
    ...
    exports.frettObservedReadingDialog = [{
            id: 'greetings',
    ...
    exports.frettObservedReadingAndInterestDialog = [{
            id: 'greetings',
            text: '    I couldn\'t help myself but to notice that you were reading the sign on the fountain - are you interested in the story behind it?',
            replies: [{
    ...
    exports.frettRepeatStoryDialog = [{
            id: 'greetings',
    ...
    exports.frettHowCanIHelpYouDialog = [{
            id: 'greetings',
    ...
    exports.frettAfterTrueNameCalledDialog = [{
            id: 'greetings',
            text: '    How can I help you?',
            replies: [{
                    text: 'I am good for now, thank you.',
...
//# sourceMappingURL=frettDialog.js.map