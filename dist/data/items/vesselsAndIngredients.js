define(["require", "exports", "./itemSlots"], function (require, exports, itemSlots_1) {
    ...
    const vesselsAndIngredients = {
        'small-bottle': {
            itemId: 'small-bottle',
            displayName: 'Small empty bottle',
            description: 'Small and cheap empty bottle, nothing special',
            possibleSlots: ['vesselSlot', ...itemSlots_1.backpackSlotNames, ...itemSlots_1.containerSlotNames],
            sprite: {
        ...
        coal: {
            ...
            possibleSlots: [...itemSlots_1.backpackSlotNames, ...itemSlots_1.containerSlotNames, ...itemSlots_1.componentSlotNames],
            sprite: {
                texture: 'base',
                frame: 69,
            },
    ...
    exports.default = vesselsAndIngredients;
});
