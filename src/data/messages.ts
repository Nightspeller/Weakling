const messages: {[key: string]: string} = {
  ...
  greatPlains_windmillSign: 'A windmill for milling different things. Right now it is under development, but you can take a look inside of it :-)',
  windmill_hopperSign: 'The logic for the hopper is under development, but the main idea is to place some wheat into the hopper upstairs and then head downstairs to pick up the processed flour.',
