const messages: {[key: string]: string} = {
  ...
  greatPlains_windmillSign: 'A windmill for milling different things. Take a look inside and give it a try :-)',
  windmill_hopperSign: 'You can use the hopper to grind grains into flour. Try putting some wheat or corn into the hopper upstairs and then head downstairs to pick up the processed flour.',
