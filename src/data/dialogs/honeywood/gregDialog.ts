...
export const gregDialog: DialogTree = [{
  id: 'greetings',
...
export const gregQuestAcceptedDialog: DialogTree = [{
  id: 'greetings',
...
export const gregAfterQuestFinishedDialog: DialogTree = [{
  id: 'garlicNotGathered',
...
export const gregJokeDialog: DialogTree = [{
  id: 'greetings',
...
export const gregJokeQuestAcceptedDialog: DialogTree = [{
  id: 'greetings',
