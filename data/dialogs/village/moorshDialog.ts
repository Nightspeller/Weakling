export const moorshDialog: DialogTree = [{
    id: 'greetings',
...
export const moorshSecondNotAcceptedDialog: DialogTree = [{
    id: 'greetings',
...
export const moorshSecondAcceptedDialog: DialogTree = [{
    id: 'greetings1',
...
export const moorshThirdDialog: DialogTree = [{
    id: 'greetings1',
