...
export const frettObservedReadingDialog = [{
        id: 'greetings',
...
export const frettObservedReadingAndInterestDialog = [{
        id: 'greetings',
        text: `    I couldn't help myself but to notice that you were reading the sign on the fountain - are you interested in the story behind it?`,
        replies: [{
...
export const frettRepeatStoryDialog = [{
        id: 'greetings',
...
export const frettHowCanIHelpYouDialog = [{
        id: 'greetings',
...
export const frettAfterTrueNameCalledDialog = [{
        id: 'greetings',
        text: `    How can I help you?`,
        replies: [{
                text: `I am good for now, thank you.`,
