...
export class CharacterDrawer {
    ...
    initializeMainImage() {
        ...
        this.clickableArea = new Rectangle(this.mainImage.getCenter().x - this.mainImage.getTopLeft().x - 48, this.mainImage.getCenter().y - this.mainImage.getTopLeft().y - 48, 96 / this.mainImage.scaleX, 96 / this.mainImage.scaleY);
    ...
    drawCharInfo() {
        ...
        const resistanceDetails = this.scene.add.text(8, 202, `🔥${this.char.currentCharacteristics.defences.fireResistance} ` +
            ...
            `✨${this.char.currentCharacteristics.defences.magicResistance} `, { font: '14px monospace', fill: '#000000' });
